...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( !lpSender->boCanShout /*|| !lpSender->boCanPage */){ //BLBLBL les pages n'ont rien � voir avec les CC...
    ...
    if( systemChannel ){//BLBLBL le channel PVP est sp�cial
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( i == mChannels.end() ){
        ...
        i = mSystemChannels.find( ciChannelID );
        if( i == mSystemChannels.end() ){
            return;//BLBL si aucune channel n'a pu �tre trouv�e c'est que personne n'�coute ce canal, inutile d'envoyer.
        }
    }
    Channel &cChannel = (*i).second;
