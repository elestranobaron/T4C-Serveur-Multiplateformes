...
//		}
    ...
    template<class A1, class A2, class A3, class A4, class A5, class A6,
        class A7, class A8, class A9, class A10, class A11, class A12,
        class A13, class A14, class A15, class A16, class A17,
        class A18, class A19, class A20, class A21, class A22,
        class A23, class A24, class A25, class A26, class A27,
        class A28, class A29, class A30, class A31, class A32,
        class A33, class A34, class A35, class A36, class A37,
        class A38, class A39, class A40, class A41>
    void Format(const CT* szFmt, const A1& v1, const A2& v2, const A3& v3,
                const A4& v4, const A5& v5, const A6& v6, const A7& v7,
                const A8& v8, const A9& v9, const A10& v10, const A11& v11,
                const A12& v12, const A13& v13, const A14& v14, const A15& v15,
                ...
                const A36& v36, const A37& v37, const A38& v38, const A39& v39,
                const A40& v40, const A41& v41)
    {
        Fmt(szFmt, FmtArg<A1>(v1)(), FmtArg<A2>(v2)(),
            FmtArg<A3>(v3)(), FmtArg<A4>(v4)(), FmtArg<A5>(v5)(),
            FmtArg<A6>(v6)(), FmtArg<A7>(v7)(), FmtArg<A8>(v8)(),
            ...
            FmtArg<A27>(v27)(),FmtArg<A28>(v28)(),FmtArg<A29>(v29)(),
            FmtArg<A30>(v30)(),FmtArg<A31>(v31)(),FmtArg<A32>(v32)(),
            FmtArg<A33>(v33)(),FmtArg<A34>(v34)(),FmtArg<A35>(v35)(),
            FmtArg<A36>(v36)(),FmtArg<A37>(v37)(),FmtArg<A38>(v38)(),
            FmtArg<A39>(v39)(),FmtArg<A40>(v40)(),FmtArg<A41>(v41)());
    }
    template<class A1, class A2, class A3, class A4, class A5, class A6,
        class A7, class A8, class A9, class A10, class A11, class A12,
        class A13, class A14, class A15, class A16, class A17,
...
inline CStdStringA operator+(const CStdStringA& s1, const CStdStringA& s2) // apparement ajout de friend jusqu en ligne 4208 n�cessaire // maintenant c contraire
{
	CStdStringA sRet(SSREF(s1));
	sRet.append(s2);
	return sRet;
}/*
friend inline CStdStringA operator+(const CStdStringA& s1, CStdStringA::value_type t)
{
	CStdStringA sRet(SSREF(s1));
	sRet.append(1, t);
	return sRet;
...
#ifdef UNICODE
	friend inline CStdStringW operator+(PCWSTR pW, const CStdStringA& sA)
	{
		return CStdStringW(pW) + CStdStringW(SSREF(sA));
	}
	friend inline CStdStringW operator+(PCSTR pA, const CStdStringW& sW)
	{
...
/*friend inline CStdStringW operator+(const CStdStringW& s1, CStdStringW::value_type t)
{
	CStdStringW sRet(SSREF(s1));
	sRet.append(1, t);
	return sRet;
...
// Define TCHAR based friendly names for some of these functions
	...
	typedef CStdStringW				CString;/////////CStdString;
